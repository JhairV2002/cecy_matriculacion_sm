...
import {SendRequestDialogComponent,
         RequestsListComponent } from './requests/requests-list/requests-list.component';
import { InscriptionComponent,
         DialogSaveComponent,
         DialogCancelComponent } from './inscription/inscription-form/inscription.component';
